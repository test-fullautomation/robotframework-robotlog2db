...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "./../RobotResults2DB")))
# print("(debug) sys.path:\n" + '\n'.join(sys.path))

# -- Project information -----------------------------------------------------

project = 'The RobotResults2DB tool'
...
latex_documents = [('index', 'RobotResults2DB.tex', project, author, 'manual', False)]
